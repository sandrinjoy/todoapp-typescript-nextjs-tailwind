...
export default function InputForm({OnInput,data,OnAdd}) {
  ...
  <button type='submit' className='bg-orange-500 border border-neutral-200 border-l-0 shadow-lg text-neutral-50 px-3 text-lg h-20 font-semibold hover:bg-orange-600 transition active:bg-orange-700  rounded-r-lg'  >
    Add  Item
  </button></form>;
}
